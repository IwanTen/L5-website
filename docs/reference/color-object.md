...
The version of `color()` with one parameter interprets the value one of two ways. If the parameter is a number, it's interpreted as a grayscale value. If the parameter is a string, it's interpreted as a CSS color string as hex color code or HTML color namex.
...
| Parameter |                                                          |
| -         | --                                                       |
| gray      | Number: number specifying value between black and white  |
| red       | Number: number specifying value 0 - 255                  |
| green     | Number: number specifying value 0 - 255                  |
| blue      | Number: number specifying value 0 - 255                  |
| alpha | Number: alpha value relative to current color range
| color name | String: color name in hex code or html color name |
                                (default is 0-255). |
